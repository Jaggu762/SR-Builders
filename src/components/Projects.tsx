...
// THERE ARE MULTIPLE CATEGORIES THAT SHOWS UP IN FRONT OF IMAGE TELLING ABOUT THE PROJECT'S CATEGORY (INDUSTRIAL, RESEDENTIAL, COMMERCIAL)
  const projects = [
    {
      id: 1,
      title: 'UNIQUE MEDICAL DEVICES',
      category: 'commercial',
      location: 'PLOT NO. 3, SEC-3, MET CITY RELAINCE DADRI TOY JHAJJAR(HR)',
      year: '2023',
      value: '2.64 Cr',
      description: 'UNIQUE MEDICAL DEVICES',
      image: 'https://raw.githubusercontent.com/Jaggu762/SR-Builders/refs/heads/main/src/components/assets/0.jpg',
      icon: Factory,
    ...
    },
    {
      ...
      category: 'industrial',
      location: 'PLOT NO. P-10,STREET NO. 7, SEC-2-B, MET CITY.',
      year: '2023',
      value: '1.28 Cr',
      description: 'ANURADHA GREEN COLLAR MANUFACTORY PVT. LTD.',
      image: 'https://raw.githubusercontent.com/Jaggu762/SR-Builders/refs/heads/main/src/components/assets/1.jpg',
      icon: Building2,
    ...
    },
    {
      ...
      title: '21 CENTURY',
      category: 'industrial',
      location: 'PLOT NO. 14, SEC-7B, MET CITY.',
      year: '2022',
      value: '1.35 Cr',
      description: 'Large-scale warehouse facility with advanced loading docks and climate control systems',
      image: 'https://raw.githubusercontent.com/Jaggu762/SR-Builders/refs/heads/main/src/components/assets/2.jpg',
      icon: Warehouse,
      gradient: 'from-blue-500 to-blue-600',
    },
    {
      id: 4,
      title: 'BOUANDERY WALL',
      category: 'industrial',
      location: 'Reliance City',
      year: '2022',
      value: '3.5 Cr',
      description: '5 K.M BOUANDERY WALL WITH MS M.S PIPE FRAME & WIRE MESH',
      image: 'https://raw.githubusercontent.com/Jaggu762/SR-Builders/refs/heads/main/src/components/assets/3.jpg',
      icon: Home,
      gradient: 'from-purple-500 to-purple-600',
    },
    {
      id: 5,
      title: 'JDS ENGINEERING',
      category: 'commercial',
      location: 'PLOT NO 41, SEC-3, MET CITY ',
      year: '2021',
      value: '1.10 Cr',
      description: 'Engineering Company Office',
      image: 'https://raw.githubusercontent.com/Jaggu762/SR-Builders/refs/heads/main/src/components/assets/4.jpg',
      icon: Store,
    ...
    },
    {
      ...
      category: 'industrial',
      location: 'Kheri Sultan (JHAJJAR)',
      year: '2021',
      value: '2.2 Cr',
      description: 'PRIVATE LAND WAREHOUSE OWNER: MR. SUKHBEER JI ',
      image: 'https://raw.githubusercontent.com/Jaggu762/SR-Builders/refs/heads/main/src/components/assets/5.jpg',
      icon: Factory,
